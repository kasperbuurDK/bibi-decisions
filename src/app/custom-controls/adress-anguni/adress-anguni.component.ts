...
import { AbstractControl, ControlValueAccessor, FormBuilder, FormGroup, NG_VALIDATORS, NG_VALUE_ACCESSOR, ReactiveFormsModule, Validator, Validators } from "@angular/forms";
...
export class AddressAnguniComponent implements ControlValueAccessor, OnDestroy, Validator {
